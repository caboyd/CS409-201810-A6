//
//  ObjShader1Light.frag
//
//  One of the standard fragment shaders used by the ObjLibrary.
//    This fragment shader is used when there is exactly one
//    active light.
//
...
void main()
{
	...
	// calculate the effects of the one light
	...
	basic_colour += ambient_surface * light_ambient * ambient_intensity +
	                diffuse_surface * light_diffuse * diffuse_intensity;

	vec3 specular_colour = specular_surface * light_specular;
