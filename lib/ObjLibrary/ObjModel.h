...
//  drawFaces
//
//  Purpose: To display all the point sets/polylines/faces in
//           the specified mesh with OpenGL graphics.
//  Parameter(s):
//    <1> mesh: Which mesh
//  Precondition(s):
//    <1> isValid()
//    <2> mesh < getMeshCount()
//  Returns: N/A
//  Side Effect: The point sets/polylines/faces in mesh mesh in
//               this ObjModel are displayed using the current
//               Material, if any.
//
...
//           point set/polyline/face from the specified mesh of
//           this ObjModel.
//  Parameter(s):
//    <1> mesh: Which mesh
//  Precondition(s):
...
//  Returns: N/A
//  Side Effect: The most recently added point set/polyline/face
//               is removed from mesh mesh of this ObjModel.
//               This ObjModel is marked as invalid.
//
